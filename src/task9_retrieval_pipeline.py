...
# Threshold theo guide; có thể hiệu chỉnh sau khi đo cosine trên query thật.
...
def retrieve(
    ...
    if use_reranking and RERANK_METHOD != "rrf" and merged:
        try:
    ...
    # Compare the original dense cosine score, never the tiny fused RRF score.
